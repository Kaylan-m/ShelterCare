    ...
    <section class="main">
      ...
      <section class="attendance">
        <div class="attendance-list">
          <h2>Fill in the form to add Adoption Data:</h2>
          <form method="POST" action="">
          <table class="table">
          <tr height="35">
                <td> </td>
                <td>ID Adopsi</td>
                <td><input type="text" placeholder="Masukkan ID Adopsi Hewan" name="id_adopsi"></td>
          </tr>
          <tr height="35">
                <td> </td>
                <td>Tanggal Adopsi</td>
                <td><input type="date" placeholder="Masukkan Tanggal Adopsi" name="tgl_adopsi"></td>
          </tr>
                        <tr height="35">
                            <td> </td>
                            <td>ID Pemilik</td>
