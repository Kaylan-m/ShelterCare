      ...
      <section class="attendance">
        <div class="attendance-list">
          ...
          <tr height="35">
                <td> </td>
                <td>ID Perawatan</td>
                <td><input type="text" placeholder="Masukkan ID Perawatan Hewan" name="id_perawatan"></td>
          </tr>
          <tr height="35">
                <td> </td>
                <td>Nama Perawatan</td>
                <td><input type="text" placeholder="Masukkan Nama Perawatan" name="nama_perawatan"></td>
          </tr>
          <tr height="35">
                <td> </td>
                <td>Deskripsi</td>
                <td><input type="text" placeholder="Masukkan Deskripsi Perawatan" name="deskripsi" ></td>
        </tr>
          <tr height="35">
                            <td> </td>
                            <td> </td>
