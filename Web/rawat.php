    ...
    <section class="main">
      ...
      <section class="attendance">
        <div class="attendance-list">
          <h1>Detail of Animal Care List</h1>
          <table class="table">
            <thead>
              <tr>
              <th>No</th>
            ...
            <?php foreach ($rawat as $row) : ?>
                ...
                <button onclick="window.location.href='edit_rawat.php?id_rawat=<?=$row["id_rawat"];?>'">Edit</button> &nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="window.location.href='delete_rawat.php?id_rawat=<?=$row["id_rawat"];?>'">Delete</button>
                </td>
