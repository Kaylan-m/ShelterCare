<?php
  ...
  $adopsi = query("SELECT * FROM adopsi");
        ...
        <div class="attendance-list">
          ...
          <table class="table">
            ...
            <?php foreach ($adopsi as $row) : ?>
                ...
                <td><?=$row["id_adopsi"];?></td>
                <td><?=$row["tgl_adopsi"];?></td>
                <td><?=$row["id_pemilik"];?></td>
                <td>
                <button onclick="window.location.href='edit_adopsi.php?id_adopsi=<?=$row["id_adopsi"];?>'">Edit</button> &nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="window.location.href='delete_adopsi.php?id_adopsi=<?=$row["id_adopsi"];?>'">Delete</button>
                </td>
