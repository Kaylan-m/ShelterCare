          ...
          <table class="table">
            ...
            <?php foreach ($perawatan as $row) : ?>
                ...
                <td><?=$i;?></td>
                    ...
                    <td><?=$row["deskripsi"];?></td>
                <td>
                <button onclick="window.location.href='edit_perawatan.php?id_perawatan=<?=$row["id_perawatan"];?>'">Edit</button> &nbsp;&nbsp;&nbsp;&nbsp;
                <button onclick="window.location.href='delete_perawatan.php?id_perawatan=<?=$row["id_perawatan"];?>'">Delete</button>
                </td>
