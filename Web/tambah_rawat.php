      ...
      <section class="attendance">
        <div class="attendance-list">
          ...
          <tr height="35">
                            <td> </td>
                            <td>ID Rawat</td>
                            <td><input type="text" placeholder="Masukkan ID Rawat" name="id_rawat"></td>
                        </tr>
                        <tr height="35">
                            <td> </td>
                            <td>ID Hewan</td>
                        ...
                        <tr height="35">
                            <td> </td>
                            <td>Deskripsi</td>
                            <td><input type="text" placeholder="Masukkan Deskripsi" name="deskripsi"></td>
                        </tr>
                        <tr height="35">
                            <td> </td>
                            <td> </td>
