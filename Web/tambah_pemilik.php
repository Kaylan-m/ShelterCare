        ...
        <div class="attendance-list">
          ...
          <table class="table">
                        <tr height="35">
                            <td> </td>
                            <td>ID Pemilik</td>
                            <td><input type="text" placeholder="Masukkan ID Pemilik Hewan" name="id_pemilik"></td>
                        </tr>
                        <tr height="35">
                            <td> </td>
                            <td>Nama Pemilik</td>
                            <td><input type="text" placeholder="Masukkan Nama Pemilik" name="nama_pemilik"></td>
                        </tr>
                        <tr height="35">
                            <td> </td>
                            <td>Alamat</td>
                            <td><input type="text" placeholder="Masukkan Alamat Pemilik" name="alamat" ></td>
                        </tr>
                        <tr height="35">
                            <td> </td>
                            <td>No Telepon</td>
